...
${OBJECTDIR}/Demo/DemoSystemManager.o: Demo/DemoSystemManager.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I../WasabiEngine -MMD -MP -MF $@.d -o ${OBJECTDIR}/Demo/DemoSystemManager.o Demo/DemoSystemManager.cpp
...
${OBJECTDIR}/Demo/GraphicDemo.o: Demo/GraphicDemo.cpp 
	${MKDIR} -p ${OBJECTDIR}/Demo
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I../WasabiEngine -MMD -MP -MF $@.d -o ${OBJECTDIR}/Demo/GraphicDemo.o Demo/GraphicDemo.cpp
